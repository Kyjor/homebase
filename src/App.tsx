...
const HouseholdGate: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'shopping' | 'calendar' | 'members'>('dashboard');
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            flex: 1,
            padding: '12px 0',
            background: activeTab === 'calendar' ? 'linear-gradient(90deg, #6366f1 0%, #60a5fa 100%)' : 'none',
        ...
        <button
          ...
          style={{
            flex: 1,
            padding: '12px 0',
            background: activeTab === 'members' ? 'linear-gradient(90deg, #6366f1 0%, #60a5fa 100%)' : 'none',
